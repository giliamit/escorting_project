...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PlanGoal>)))
  ...
  "f26bde92cb12266642e4b0c1fc5f674d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PlanGoal)))
  "Returns md5sum for a message object of type 'PlanGoal"
  "f26bde92cb12266642e4b0c1fc5f674d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PlanGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Planning action definition~%# goal definition~%string domain_path~%string problem_path~%string data_path~%string planner_command~%uint64 start_action_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PlanGoal)))
  "Returns full string definition for message of type 'PlanGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Planning action definition~%# goal definition~%string domain_path~%string problem_path~%string data_path~%string planner_command~%uint64 start_action_id~%~%~%"))
