...
class PlanGoal(genpy.Message):
  _md5sum = "f26bde92cb12266642e4b0c1fc5f674d"
...
"""
  __slots__ = ['domain_path','problem_path','data_path','planner_command','start_action_id']
  _slot_types = ['string','string','string','string','uint64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       domain_path,problem_path,data_path,planner_command,start_action_id
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_Q.pack(self.start_action_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.start_action_id,) = _struct_Q.unpack(str[start:end])
      return self
