...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.update_type, _x.knowledge.knowledge_type))
      ...
      for val1 in self.knowledge.values:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_dB.pack(_x.knowledge.function_value, _x.knowledge.is_negative))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.update_type, _x.knowledge.knowledge_type,) = _struct_2B.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.knowledge.function_value, _x.knowledge.is_negative,) = _struct_dB.unpack(str[start:end])
