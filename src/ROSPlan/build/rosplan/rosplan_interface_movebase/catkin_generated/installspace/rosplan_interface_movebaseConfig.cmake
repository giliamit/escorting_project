...
if("FALSE" STREQUAL "TRUE")
  set(rosplan_interface_movebase_SOURCE_PREFIX /home/robot/catkin_ws_escorting/src/ROSPlan/src/rosplan/rosplan_interface_movebase)
  set(rosplan_interface_movebase_DEVEL_PREFIX /home/robot/catkin_ws_escorting/src/ROSPlan/devel)
  ...
  set(rosplan_interface_movebase_INSTALL_PREFIX /home/robot/catkin_ws_escorting/src/ROSPlan/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosplan_interface_movebase' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws_escorting/src/ROSPlan/install/${idir}'.  Ask the maintainer 'michael <michael.cashmore@kcl.ac.uk>' to fix it.")
    endif()
