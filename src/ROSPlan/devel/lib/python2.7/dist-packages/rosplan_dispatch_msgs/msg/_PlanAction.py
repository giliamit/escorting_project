...
class PlanAction(genpy.Message):
  _md5sum = "aa1b43f9aeb875c80ffa047c22dd9b87"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Q3I.pack(_x.action_goal.goal.start_action_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.percent_completed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.start_action_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_Q3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.percent_completed,) = _struct_i.unpack(str[start:end])
      return self
